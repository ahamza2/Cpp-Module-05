...
void ShrubberyCreationForm::execute(const Bureaucrat& executor) const {
	...
	std::cout << this->getSign() << " ---- " <<  executor.getGrade() << " ----- " << this->get_Grade() << " -------- " << executor.getGrade() << " ----- " << this->getExecGrade() << std::endl;
	if (executor.getGrade() > this->get_Grade() || executor.getGrade() > this->getExecGrade())
    {
        throw AForm::GradeTooLowException();
    }
